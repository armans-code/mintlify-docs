...
1. Ajoutez le contenu que vous souhaitez réutiliser à plusieurs endroits dans votre fichier d'extrait. Vous pouvez éventuellement ajouter des variables qui peuvent être remplies via des props lorsque vous importez l'extrait.
